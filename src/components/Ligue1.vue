    ...
    <div id="app" class="container">
        ...
        <div class="championnat row" v-else>
            <div class="drapeau col-12 col-md-6 col-lg-2">
                <img src="../assets/ligue1.png" alt="championnat">
            </div>
                ...
                <div class="accordion">
                    <div class="container2">
                        ...
                        <div class="content row">
                          <Matchs class="col-12 col-md-6 col-lg-3 mb-3" v-for="(matchs, i) in matchsL1" :key="'S' + i" :match="matchs"/>
                        </div>
                    </div>
                    <hr>
                    <div class="container2">
                        ...
                        <div class="content row">
                          <Resultats class="col-12 col-md-6 col-lg-3 mb-3" v-for="(matchs, i) in matchsL1" :key="'R' + i" :match="matchs"/>
                        </div>
                    </div>
                    <hr>
                    <div class="container2">
                        ...
                        <div class="content">
                            <table class="classement">
                                ...
                                <tbody>
                                  <Classement v-for="(standing, i) in standingL1" :key="'C' + i" :place="standing"/> 
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="container2">
                        ...
                        <div class="content row">
                          <Equipes class="col-12 col-md-3 p-2" v-for="(teams, i) in teamsL1" :key="'E' + i" :team="teams"/>
                        </div>
                    </div>
                    <hr>
                    <div class="container2">
                        ...
                        <div class="content row">
                          <Buteurs class="col-12 col-lg-6 p-2" v-for="(scorers, i) in scorersL1" :key="'G' + i" :scorer="scorers"/>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        ...
        // Championnat
        axios.get('https://api.football-data.org/v2/competitions/FL1', {headers: { "X-Auth-Token": "d6bb4175db1246bf90df60886d70fedb"}})
        ...
        // Matchs 
        axios.get('https://api.football-data.org/v2/competitions/FL1/matches', {headers: { "X-Auth-Token": "d6bb4175db1246bf90df60886d70fedb"}})
