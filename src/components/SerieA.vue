    ...
    <div id="app" class="container">
        ...
        <div class="championnat row" v-else>
            <div class="drapeau col-12 col-md-6 col-lg-2">
                <img src="../assets/seriea.png" alt="championnat">
            </div>
                ...
                <div class="accordion">
                    <div class="container2">
                        ...
                        <div class="content row">
                            <Matchs class="col-12 col-md-6 col-lg-3 mb-3" v-for="(matchs, i) in matchsSA" :key="'S' + i" :match="matchs"/>
                        </div>
                    </div>
                    <hr>
                    <div class="container2">
                        ...
                        <div class="content row">
                            <Resultats class="col-12 col-md-6 col-lg-3 mb-3" v-for="(matchs, i) in matchsSA" :key="'R' + i" :match="matchs"/>
                        </div>
                    </div>
                    <hr>
                    <div class="container2">
                        ...
                        <div class="content">
                            <table class="classement">
                                ...
                                <tbody>
                                    <Classement v-for="(standing, i) in standingSA" :key="'C' + i" :place="standing"/> 
                                </tbody>
                            </table>
                        </div>
                    </div>
                    ...
                    <div class="container2">
                        ...
                        <div class="content row">
                            <Equipes class="col-12 col-md-3 p-2" v-for="(teams, i) in teamsSA" :key="'E' + i" :team="teams"/>
                        </div>
                    </div>
                    <hr>
                    <div class="container2">
                        ...
                        <div class="content row">
                                <Buteurs class="col-12 col-lg-6 p-2" v-for="(scorers, i) in scorersSA" :key="'G' + i" :scorer="scorers"/>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    mounted() {
        ...
        // Championnat
        axios.get('https://api.football-data.org/v2/competitions/SA', {headers: { "X-Auth-Token": "d6bb4175db1246bf90df60886d70fedb"}})
        ...
        // Matchs 
        axios.get('https://api.football-data.org/v2/competitions/SA/matches', {headers: { "X-Auth-Token": "d6bb4175db1246bf90df60886d70fedb"}})
        ...
        // Classement
        axios.get('https://api.football-data.org/v2/competitions/2019/standings', {headers: { "X-Auth-Token": "d6bb4175db1246bf90df60886d70fedb"}})
        ...
        // Equipes
        axios.get('https://api.football-data.org/v2/competitions/2019/teams', {headers: { "X-Auth-Token": "d6bb4175db1246bf90df60886d70fedb"}})
